package br.com.ratacheski.bluefood.application.test;
...
import br.com.ratacheski.bluefood.domain.pedido.StatusPedido;
...
public class InsertDataForTesting {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        if (environment.acceptsProfiles(Profiles.of("dev"))) {
            ...
            p.setStatusPedido(StatusPedido.PRODUCAO);
    ...
    private Restaurante[] restaurantes() {
        ...
        CategoriaRestaurante categoriaPizza = categoriaRestauranteRepository.findById(Long.valueOf(1)).orElseThrow(NoSuchElementException::new);
        CategoriaRestaurante categoriaSanduiche = categoriaRestauranteRepository.findById(Long.valueOf(2)).orElseThrow(NoSuchElementException::new);
        CategoriaRestaurante categoriaSobremesa = categoriaRestauranteRepository.findById(Long.valueOf(5)).orElseThrow(NoSuchElementException::new);
        CategoriaRestaurante categoriaJapones = categoriaRestauranteRepository.findById(Long.valueOf(6)).orElseThrow(NoSuchElementException::new);

        Restaurante r = new Restaurante();
        r.setNome("Bubger King");
        r.setEmail("r1@bluefood.com.br");
        r.setSenha(StringUtils.encrypt("123"));
    ...
    private Cliente[] clientes() {
        ...
        c.setSenha(StringUtils.encrypt("123"));
        c.setCep("89300100");
